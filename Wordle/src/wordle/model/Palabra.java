...
public class Palabra {
	...
	public boolean validarMCN(String cadena) {
		...
		if(cont==0) {
			...
			JOptionPane.showMessageDialog(null, "La palabra no debe contener mayusculas ni caracteres epeciales.");
			
		}
		System.out.println(r + "La palabra no debe contener caracteres especiales ni mayusculas, intención de nuevo.");
		return r;
	}
